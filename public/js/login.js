// Remove the following line since password-revealer will be included separately
// const passwordRevealer = new PasswordRevealer(document.querySelector('#password-login'));
